...
describe Junction do
  ...
  it { is_expected.to validate_uniqueness_of(:clause_id).scoped_to(:parent_clause_id).allow_nil }
  it { is_expected.to validate_uniqueness_of(:condition_id).scoped_to(:parent_clause_id).allow_nil }
